"""Provider-neutral media conversion helpers for typed payloads.

This module only converts between tensors and PIL images. Provider-specific
media objects are constructed by observer adapters, so the typed helper layer
has no telemetry SDK dependency.
"""
...
__all__ = ["hstack_pils", "tensor_frame_to_pil", "tensor_to_pil"]
