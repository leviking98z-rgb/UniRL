"""Build the local ArxivQA dataset used by the Bagel multiple-choice recipe.

Same on-disk layout as :mod:`unirl.data.prepare.geo3k_mc` (so the multimodal RL data
...
Usage:
  python -m unirl.data.prepare.arxivqa_mc --out-dir data/arxivqa_mc
