...
of ``prepare_dapo_math.py``.
  ...
  python -m unirl.data.prepare.asearcher --out-dir data/asearcher
  # or convert a local jsonl (tolerant of field names):
  python -m unirl.data.prepare.asearcher --source path/to/asearcher.jsonl --out-dir data/asearcher
"""
