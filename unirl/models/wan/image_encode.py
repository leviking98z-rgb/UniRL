"""WANImageLatentEncodeStage — shared WAN image-conditioning encoder.
...
``wan/vae.py`` (decode = ``latent * std + mean``).
"""
...
WANImageLatentEncodeStage = WAN21ImageLatentEncodeStage


__all__ = ["WAN21ImageLatentEncodeStage", "WANImageLatentEncodeStage"]
