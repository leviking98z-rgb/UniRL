"""WANCLIPVisionEncodeStage — shared WAN CLIP image encoder.
...
WANCLIPVisionEncodeStage = WAN21CLIPVisionEncodeStage


__all__ = ["WAN21CLIPVisionEncodeStage", "WANCLIPVisionEncodeStage"]
