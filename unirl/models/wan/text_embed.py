"""WANTextEmbedStage — shared WAN UMT5 prompt encoding.
...
``WANConditions(text=pos, negative_text=neg)``.
...
class WAN21TextEmbedStage(EmbedStage[Texts, TextEmbedCondition]):
    """WAN-family UMT5 text → TextEmbedCondition stage."""
...
WANTextEmbedStage = WAN21TextEmbedStage


__all__ = ["WAN21TextEmbedStage", "WANTextEmbedStage"]
